...
window.D3NetworkGraph = window.D3NetworkGraph || {};

let graphInstances = {};

// Export functions for C# interop
window.D3NetworkGraph.initialize = function(containerId, options) {
...
window.D3NetworkGraph.setData = function(containerId, data) {
...
window.D3NetworkGraph.addNode = function(containerId, node) {
    const instance = graphInstances[containerId];
...
window.D3NetworkGraph.addLink = function(containerId, link) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.removeNode = function(containerId, nodeId) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.updateNode = function(containerId, nodeId, updates) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.clearGraph = function(containerId) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.zoom = function(containerId, scale) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.resetZoom = function(containerId) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.focusNode = function(containerId, nodeId) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.highlightNode = function(containerId, nodeId) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.clearHighlights = function(containerId) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.setLayout = function(containerId, layoutType) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.enableSimulation = function(containerId, enable) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
...
window.D3NetworkGraph.destroy = function(containerId) {
    const instance = graphInstances[containerId];
    if (!instance) return false;
